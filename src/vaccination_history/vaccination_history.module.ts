...
import { VaccinationHistory, VaccinationSchema } from './schemas/vaccination_history.entity';

@Module({
  imports:[MongooseModule.forFeature([{name:VaccinationHistory.name, schema:VaccinationSchema}])],
